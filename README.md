...
La prima volta che serve davvero, si apre il browser per un **accesso all'AI**: fai il **login** se hai già un account, oppure **registrati** (sign up) se è la prima installazione o non l'hai mai configurata su questo Mac. È rapido e si fa **una volta sola**; poi torni al Terminale. Non devi creare o copiare nessuna chiave.
